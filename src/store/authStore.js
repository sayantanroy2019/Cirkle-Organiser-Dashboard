...
const STORAGE_KEY = 'cirkle-organizer-auth'

/**
 * Session store for the organizer.
 *
 * The token (and the small, non-sensitive organizer profile used by the
 * topbar) are persisted to localStorage so a refresh doesn't bounce the
 * organizer back to login. Nothing else is stored in the browser.
 */
